...
#define FUDGE_GOOGLE_LAT 49 //Local calibration of Google GPS Lat, a difference of 100 ~ 30' (Truglodite=7540)
#define FUDGE_GOOGLE_LON 116 //Local calibration of Google GPS Long, a difference of 100 ~ 30'  (Truglodite=4280)
...
#define SCREEN_AND_SENSOR_UPDATES_PER_SEC 2
